                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="rulename" placeholder="请输入权限组名">
                        </div>
                        <div class="form-group">
                            <label for="url">权限组访问路径url</label>
                            <input type="text" class="form-control" id="url" placeholder="请输入访问路径url">
                        </div>
