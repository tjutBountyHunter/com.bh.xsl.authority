                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hunterid" placeholder="猎人等级id">
                        </div>
                        <div class="form-group">
                            <label for="hunterlevel">猎人等级</label>
                            <input type="text" class="form-control" id="hunterlevel" placeholder="猎人等级">
                        </div>
                        <div class="form-group">
                            <label for="experience">猎人等级经验值</label>
                            <input type="text" class="form-control" id="experience" placeholder="请输入猎人等级经验值">
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            if ( hunterid == "" ) {
                layer.msg("猎人等级ID不能为空，请输入", {time:2000, icon:5, shift:6}, function(){

                });
                return;
            }

            var hunterlevel = $("#hunterlevel").val();
            if ( hunterlevel == "" ) {
            ...
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/hunterexperience/insert",
                data : {
                    "hunterlevelid" : hunterid,
                    "level" : hunterlevel,
                ...
                success : function(data) {
                    ...
                    if ( data.status==200 ) {
                        layer.msg("猎人等级经验信息保存成功", {time:1000, icon:6}, function(){
                            window.location.href = "${APP_PATH}/hunterexperience/index";
                        });
                    } else {
                        layer.msg("猎人等级经验信息添加失败，请重新操作", {time:2000, icon:5, shift:6}, function(){
