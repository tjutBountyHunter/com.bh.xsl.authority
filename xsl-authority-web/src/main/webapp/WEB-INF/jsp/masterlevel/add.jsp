                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label for="name">雇主等级名</label>
                            <input type="text" class="form-control" id="name" placeholder="请输入雇主等级名">
                        </div>
                        <div class="form-group">
                            <label for="level">雇主等级</label>
                            <input type="text" class="form-control" id="level" placeholder="请输入雇主等级">
                        </div>
                        <div class="form-group">
                            <label for="descr">雇主等级描述</label>
                            <input type="text" class="form-control" id="descr" placeholder="请输入雇主等级描述">
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/masterlevel/insert",
                data : {
                    "level":level,
                ...
                success : function(data) {
                    ...
                    if ( data.status==200 ) {
                        layer.msg("雇主等级信息保存成功", {time:1000, icon:6}, function(){
