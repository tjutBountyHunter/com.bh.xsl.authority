                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label for="rulename">特权名</label>
                            <input type="text" class="form-control" id="rulename" placeholder="请输入特权名">
                        </div>
                        <div class="form-group">
                            <label for="url">特权访问url</label>
                            <input type="text" class="form-control" id="url" placeholder="请输入特权访问路径url">
                        </div>
                        <div class="form-group">
                            <label for="priority">优先级</label>
                            <input type="text" class="form-control" id="priority" placeholder="请输入特权优先级">
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#insertBtn").click(function(){
            ...
            if ( rulename == "" ) {
                layer.msg("特权名不能为空，请输入", {time:2000, icon:5, shift:6}, function(){
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if ( data.status==200 ) {
                        layer.msg("特权信息保存成功", {time:1000, icon:6}, function(){
                            window.location.href = "${APP_PATH}/privilege/index";
                        });
                    } else {
                        layer.msg("特权信息添加失败，请重新操作", {time:2000, icon:5, shift:6}, function(){
