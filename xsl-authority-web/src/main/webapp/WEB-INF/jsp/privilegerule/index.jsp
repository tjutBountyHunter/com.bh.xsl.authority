...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var setting = {
            async : {
                enable :true,
                url : "${APP_PATH}/privilege/loaddata",
    ...
    function addNode(id) {
        window.location.href="${APP_PATH}/privilege/add?id="+id;
    }
    function editNode(id) {
        window.location.href = "${APP_PATH}/privilege/edit?id="+id;
    }

    function deleteNode(id) {
        layer.confirm("删除特权信息, 是否继续",  {icon: 3, title:'提示'}, function(cindex){
            // 删除选择的用户信息
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/privilege/delete",
                data : {
                    id : id
                },
                success : function(data) {
                    if ( data.status == 200 ) {
                        ...
                        layer.msg("特权信息信息删除失败", {time:2000, icon:5, shift:6}, function(){
