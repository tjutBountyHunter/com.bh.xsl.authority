            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form id="roleForm" role="form" class="form-inline">
                        <input type="hidden" name="managerid" value="${admin.id}">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            <label for="assingedRoles">已分配角色列表</label><br>
    ...
    $(function () {
        ...
        $("#left2RightBtn").click(function(){
            ...
            if ( opts.length == 0 ) {
                ...
                $.ajax({
                    type : "POST",
                    url  : "${APP_PATH}/managers/doRoleAssign",
        ...
        $("#right2LeftBtn").click(function(){
            ...
            if ( opts.length == 0 ) {
                ...
                $.ajax({
                    type : "POST",
                    url  : "${APP_PATH}/managers/dounRoleAssign",
                    data : $("#roleForm").serialize(),
                    success : function(data) {
                        if ( data.status == 200 ) {
