            ...
            <div class="panel-body">
                <form role="form"  id="adminForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" value="${admin.managerName}" placeholder="请输入名字">
                    </div>
                    <div class="form-group">
                        <label for="oldpassword">管理员登陆密码</label>
                        <input type="password" class="form-control" id="oldpassword" placeholder="请输入修改密码">
                    </div>
                    <div class="form-group">
                        <label for="newpassword">再次输入管理员登陆密码</label>
                        <input type="password" class="form-control" id="newpassword" placeholder="请输入修改密码">
                    </div>
    ...
    $(function () {
        ...
        $("#updateBtn").click(function(id){
            ...
            if(oldpassword!=newpassword){
                layer.msg("两次输入的密码匹配不正确", {time:2000, icon:5, shift:6}, function(){
            ...
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/managers/update",
                data : {
                    "id"   : "${param.id}",
                    "managerName" : adminname,
                    "managerPassword" : oldpassword
                },
                beforeSend : function() {
